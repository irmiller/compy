...
var (
	...
	ca    = flag.String("ca", "/root/go/bin/cert.crt", "CA path")
	caKey = flag.String("cakey", "/root/go/bin/cert.key", "CA key path")
	...
	jpeg   = flag.Int("jpeg", 10, "jpeg quality (1-100, 0 to disable)")
