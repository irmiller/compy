...
func (p *Proxy) handle(w http.ResponseWriter, r *http.Request) error {
	...
	log.Printf("Transcoded: %.2f%MB -> %.2f%MB (%3.1f%%)", float64(written/10000), float64(read/10000), float64(written)/float64(read)*100)
...
<li><a href="https://github.com/irmiller/compy">GitHub</a></li>
</ul>
</body>
